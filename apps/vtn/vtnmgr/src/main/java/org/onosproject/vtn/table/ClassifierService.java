...
public interface ClassifierService {
    ...
    /**
     * Assemble the icmpp Classifier table rules for internal network gateway ping.
     * Match: inport and gateway ip.
     * Action: upload packet to controller.
     *
     * @param deviceId Device Id
     * @param inPort the ingress port of the host
     * @param gatewayIp internal network gateway ip
     * @param type the operation type of the flow rules
     */
    void programIcmpRules(DeviceId deviceId, PortNumber inPort,
                          IpAddress gatewayIp, Operation type);
}
