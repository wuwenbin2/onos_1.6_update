...
public class VtnManager implements VtnService {
    ...
    private void applyHostMonitoredL2Rules(Host host, Objective.Operation type) {
        ...
        classifierService.programIcmpRules(deviceId, inPort, gatewayIp,
                                           type);
        if (type == Objective.Operation.ADD) {
    ...
    private void processPacketIn(InboundPacket pkt) {
        ...
        if (((ICMP) ipv4.getPayload())
                .getIcmpType() == ICMP.TYPE_ECHO_REQUEST) {
    ...
    private void sendIcmpResponse(Ethernet icmpRequest, ConnectPoint outport) {
        ...
        icmpReply
                .setPayload(((ICMP) icmpRequestIpv4.getPayload()).getPayload());
        ...
        icmpReplyEth
                .setDestinationMACAddress(icmpRequest.getSourceMACAddress());
        icmpReplyEth
